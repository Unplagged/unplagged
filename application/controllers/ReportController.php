...
class ReportController extends Unplagged_Controller_Versionable {
   ...
   */
  private function createReport(Application_Model_User $user, $reportData) {
    $data = array(
    ...
    $report = new Application_Model_Report($data, $user, $user->getCurrentCase(), $user->getCurrentCase()->getTarget());
