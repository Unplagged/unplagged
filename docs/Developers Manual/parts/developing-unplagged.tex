...
And again, to make it work you can set the ini directive \texttt{simtext.simtextPath} to the appropriate path.
...
simply for different screen resolutions. And so do we. 
...
browsers that don't 
support them, just display the default css for desktop browsers, which is optimized for a width of about 1000 pixels.
