...
%(siehe http://www.plagiarism.org/plag_article_what_is_plagiarism.html)
...
\begin{itemize}
   \item turning in someone else's work as your own
   \item copying words or ideas from someone else without giving credit
   \item failing to put a quotation in quotation marks
  \item  giving incorrect information about the source of a quotation
  \item  changing words but copying the sentence structure of a source without giving credit
   \item copying so many words or ideas from a source that it makes up the majority of your work, whether you give credit or not (see our section on "fair use" rules)
\end{itemize} 
